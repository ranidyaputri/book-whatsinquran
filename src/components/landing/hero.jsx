...
function Hero() {
  return (
    <div className="hero-section mx-[60px] mt-[128px] min-h-[380px] bg-[#33187A] rounded-[40px] px-[58px] py-[40px]">
        <div className="flex justify-between items-center">
            <div className="hero-text text-white w-[448px]">
                <h1 className="font-bold text-[50px]">Flip Through Faith</h1>
